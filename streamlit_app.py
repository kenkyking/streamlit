...
st.set_page_config(
    page_title="Income Prediction App - Ahmad Nadhif, A11.2023.15167",
    page_icon="💰",
    layout="wide",
...
# Main app
st.title("💰 Income Prediction App - Ahmad Nadhif, A11.2023.15167")
...
# Footer
st.markdown("---")
st.markdown("*Built with Streamlit • Ahmad Nadhif - A11.2023.15167*")